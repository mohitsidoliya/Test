...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2019 at 09:10 PM
...
CREATE TABLE `categories` (
  ...
  `meta_keyword` varchar(700) DEFAULT NULL,
...
--
-- Table structure for table `master_configrations`
--

CREATE TABLE `master_configrations` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `description` text,
  `created_at` datetime NOT NULL,
...
CREATE TABLE `products` (
  ...
  `super_category_subcategory_id` int(11) DEFAULT NULL,
  ...
  `slug` varchar(400) NOT NULL,
  `is_active` int(1) NOT NULL,
  `product_type` enum('MADETOMEASURE','READYMADE') NOT NULL DEFAULT 'MADETOMEASURE'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `product_color_sizes` (
  ...
  `sell_cost` double(10,2) NOT NULL,
...
--
-- Table structure for table `super_category_subcategories`
--

CREATE TABLE `super_category_subcategories` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `super_category_subcategory_sizes`
--

CREATE TABLE `super_category_subcategory_sizes` (
  `id` int(11) NOT NULL,
  `super_category_subcategory_id` int(11) DEFAULT NULL,
  `size_id` int(11) DEFAULT NULL,
  `fabric_length` double(10,2) NOT NULL,
  `created_at` datetime NOT NULL,
  `is_active` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `super_category_subcategory_size_master_configrations`
--

CREATE TABLE `super_category_subcategory_size_master_configrations` (
  `id` int(11) NOT NULL,
  `master_configration_id` int(11) DEFAULT NULL,
  `super_category_subcategory_size_id` int(11) DEFAULT NULL,
...
--
-- Indexes for table `master_configrations`
--
ALTER TABLE `master_configrations`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `super_category_subcategory_id` (`super_category_subcategory_id`);
...
--
-- Indexes for table `super_category_subcategories`
--
ALTER TABLE `super_category_subcategories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `super_category_subcategory_sizes`
--
ALTER TABLE `super_category_subcategory_sizes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `super_category_subcategory_id` (`super_category_subcategory_id`),
  ADD KEY `size_id` (`size_id`);

--
-- Indexes for table `super_category_subcategory_size_master_configrations`
--
ALTER TABLE `super_category_subcategory_size_master_configrations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `master_configration_id` (`master_configration_id`),
  ADD KEY `super_category_subcategory_size_id` (`super_category_subcategory_size_id`);
...
--
-- AUTO_INCREMENT for table `master_configrations`
--
ALTER TABLE `master_configrations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `super_category_subcategories`
--
ALTER TABLE `super_category_subcategories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `super_category_subcategory_sizes`
--
ALTER TABLE `super_category_subcategory_sizes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `super_category_subcategory_size_master_configrations`
--
ALTER TABLE `super_category_subcategory_size_master_configrations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `FK_B3BA5A5ABCD6BD6A` FOREIGN KEY (`super_category_subcategory_id`) REFERENCES `super_category_subcategories` (`id`);

--
-- Constraints for table `product_color_sizes`
--
ALTER TABLE `product_color_sizes`
  ADD CONSTRAINT `FK_6B7D4BC44584665A` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `FK_6B7D4BC4498DA827` FOREIGN KEY (`size_id`) REFERENCES `sizes` (`id`),
  ADD CONSTRAINT `FK_6B7D4BC47ADA1FB5` FOREIGN KEY (`color_id`) REFERENCES `colors` (`id`);

--
-- Constraints for table `super_category_subcategories`
--
ALTER TABLE `super_category_subcategories`
  ADD CONSTRAINT `fk_s_c_s_category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `fk_s_c_s_subcategory_id` FOREIGN KEY (`subcategory_id`) REFERENCES `subcategories` (`id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `fk_s_c_s_super_category_id` FOREIGN KEY (`super_category_id`) REFERENCES `super_categories` (`id`) ON DELETE NO ACTION;

--
-- Constraints for table `super_category_subcategory_sizes`
--
ALTER TABLE `super_category_subcategory_sizes`
  ADD CONSTRAINT `FK_D4003550498DA827` FOREIGN KEY (`size_id`) REFERENCES `sizes` (`id`),
  ADD CONSTRAINT `fk_s_c_s_size_super_category_subcategory_id` FOREIGN KEY (`super_category_subcategory_id`) REFERENCES `super_category_subcategories` (`id`);

--
-- Constraints for table `super_category_subcategory_size_master_configrations`
--
ALTER TABLE `super_category_subcategory_size_master_configrations`
  ADD CONSTRAINT `FK_E1537B50626695A3` FOREIGN KEY (`super_category_subcategory_size_id`) REFERENCES `super_category_subcategory_sizes` (`id`),
  ADD CONSTRAINT `FK_E1537B50EE87F94D` FOREIGN KEY (`master_configration_id`) REFERENCES `master_configrations` (`id`);
COMMIT;
